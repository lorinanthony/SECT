...
load("~/Dropbox/Columbia Radiogenomics/Analysis/Cross_Validation_Results/GaussCV_Results.RData");
...
### Save the Results ###
save(Res,file = "~/Dropbox/Columbia Radiogenomics/Analysis/Results/Gauss_SECT.RData")
